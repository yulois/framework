...
$<?php echo $model ?>->addUniqueIndex(<?php echo \Yulois\Tools\Util::parsetArrayToString($unique); ?>);
<?php } ?>
<?php if( $primary ) {?>
$<?php echo $model ?>->setPrimaryKey(<?php echo \Yulois\Tools\Util::parsetArrayToString($primary); ?>);
<?php } ?>
<?php
$unique = array();
$primary = array();
