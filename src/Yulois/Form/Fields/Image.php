...
Class Image extends \Yulois\Form\Fields\File
{
	...
	public function valid()
	{
		...
		if ( $isValid && (count($this->max_dimensions) || count($this->min_dimensions)) )
		{
			...
			\Yulois\Tools\File::copy( $value->getPathname(), YS_PUBLIC . '/tmp/'.$name_tmp );
	...
	public function renderField()
	{
		...
		return \Yulois\Helper\FormHtml::file($format, null, array(
					'id' => $id,
