...
Class Form extends InterfaceForm
{
	...
	public function renderRow( \Yulois\Form\Field $widget )
	{
		// Crea los campos ocultos
		if ( $widget->isHidden() )
		{
			return \Yulois\Helper\FormHtml::hidden($this->name_form . '[' . $widget->getName() . ']', $widget->getValue(), $widget->getMaxlength(), array(
